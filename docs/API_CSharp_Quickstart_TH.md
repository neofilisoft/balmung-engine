# VoxelBlock API (C#) สำหรับผู้เริ่มต้น

เอกสารนี้อธิบายการใช้ `VoxelBlock.Bridge` ผ่าน C# โดยไม่ต้องรู้ C++ มาก่อน
...
## ข้อควรระวัง (Runtime)
- native DLL ต้องอยู่ใน path ที่แอปหาเจอ (`voxelblock.dll`)
...
ฝั่ง `VoxelBlock.Editor` ใช้ API นี้อยู่แล้วสำหรับ:
