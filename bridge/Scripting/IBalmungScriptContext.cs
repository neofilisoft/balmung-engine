...
namespace Balmung.Bridge.Scripting
{
    public interface IVoxelScriptContext
    {
        bool IsEngineReady { get; }
        BalmungEngine? Engine { get; }
    ...
    {
        private readonly Func<BalmungEngine?> _engineAccessor;
        private readonly Action<string>? _logger;

        public VoxelScriptContext(Func<BalmungEngine?> engineAccessor, Action<string>? logger = null)
        {
        ...
        public BalmungEngine? Engine => _engineAccessor();
