...
namespace {
constexpr const char* kBalmungDefaultFontManifest = "engine/font/default_font.json";
}


namespace Balmung::UI {
// The default engine font family is described in engine/font/default_font.json.
// Runtime loaders can use this manifest to resolve the actual font asset on disk.
