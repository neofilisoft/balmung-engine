...
public:
    struct StreamingSettings {
        int load_radius = 5;
        int unload_margin = 2;
        int min_load_radius = 1;
        bool seamless_streaming = true;
    };
    ...
    struct StreamingStats {
        ...
        int loaded_chunks = 0;
        int chunks_loaded_this_update = 0;
        int chunks_unloaded_this_update = 0;
    };
    ...
    void set_streaming_settings(StreamingSettings settings) noexcept;
    [[nodiscard]] const StreamingSettings& streaming_settings() const noexcept { return _streaming; }
    [[nodiscard]] const StreamingStats& streaming_stats() const noexcept { return _streaming_stats; }
    void update_chunks(float focus_x, float focus_z, int load_radius = 0);
...
private:
    ...
    StreamingSettings _streaming{};
    StreamingStats _streaming_stats{};
